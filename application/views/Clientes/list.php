                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-5 selectContainer">
                                            ...
                                            <? for($a���o = 2010; $a���o <= 2020; $a���o++ ) { ?>
                                                <option value = <?echo $a���o?> <?php if ($anioInicial==$a���o) echo "selected";?>><?echo $a���o?></option>
                                            <?}?>
                                            </select>
                                        </div>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="col-xs-5 selectContainer">
                                            ...
                                            <? for($a���o = 2010; $a���o <= 2020; $a���o++ ) { ?>
                                                <option value = <?echo $a���o?> <?php if ($anioFinal==$a���o) echo "selected";?> ><?echo $a���o?></option>
                                            <?}?>
                                            </select>
                                        </div>
                                    </td>
